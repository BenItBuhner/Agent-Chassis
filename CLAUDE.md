...
Agent Chassis is a modular, asynchronous foundation for building AI agents with FastAPI, OpenAI, and MCP (Model Context Protocol). This document provides detailed context for AI assistants working on this codebase.
